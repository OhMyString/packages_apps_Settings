...
public class scndmCardPrefWallBlur extends ImageView {

    Context contextM;

    public scndmCardPrefWallBlur(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }

    public scndmCardPrefWallBlur(Context context, AttributeSet attrs) {
        super(context, attrs);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }
    ...
    public scndmCardPrefWallBlur(Context context) {
        super(context);
        contextM = context;
        setRenderEffect(RenderEffect.createBlurEffect(30, 30, Shader.TileMode.CLAMP));
    }
